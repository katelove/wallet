<template lang="">
    <fragment>
        <div class="pt-12px mx-12px">
            <BlueContainer title="充值/收款">
                <div class="mx-20px my-23px">
                    <div class="flex justify-between">
                        <div class="flex">
                            <img :src="getCryptoImgUrl()" class="mr-12px"/>
                    ...
                    <div class="py-14px px-15px border border-black rounded-10px">
                        <div class="flex justify-between mb-4">
                            ...
                            <div class="flex items-center text-graniteGrey text-12px">
                                <p>修改</p>
                                <p class="ml-10px">刪除</p>
                            </div>
                        </div>
                        <div class="flex justify-between items-center">
                            <p class="text-12px self-end text-graniteGrey">DWFRF345345FR34fk4tj4jf4j444rj</p>
                            <Button
            ...
            <div v-show="showCopy" class="flex py-25px px-23px bg-diamondGrey rounded-10px items-center text-14px">
                <div>
