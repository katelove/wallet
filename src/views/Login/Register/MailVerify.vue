<template>
  <div>
    <Title class="flex justify-center mt-10" heading="邮箱验证"></Title>
    <div
    ...
    >
      ...
      <Input type="text" class="w-full h-8.5 mt-6 text-center text-base" placeholder="邮箱验证码" />
      <button class="bg-melancholyBlue text-white rounded-2px w-full h-10 mt-12" @click="home">确认</button>
